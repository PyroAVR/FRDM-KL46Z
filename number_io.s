...
get_log:    lsls r1, r1, #1 //reverse, reverse! (loop runs 1 time too many)
            //r1 now has the smallest power of two greater than .equ or, al to
            //the number given on r0.  Now, acquire the exponent of that power
            //which again .equ r, ires a stupid amount of iteration but whatever
...
pnu_loop:   cmp  r1, #10
            ...
            b    pnu_err 
            //if the quotient is greater than .equ or, al to ten, the initial 
...
teststr: .ascii "hello world"		//a true classic
.equ len_teststr, .-teststr
input_pr: .ascii "Enter a string:"
          .byte CR, LF,'>', 0
strlen_pr: .ascii "Length:"
           .byte 0 
// log lookup table.
...
bin2dec_lut:  .word 1, 1, 1, 1, 10, 10, 10, 100, 100, 100, 1000, 1000, 1000
              ...
              .word 100000000, 100000000, 100000000, 1000000000, 1000000000
//>>>>>   end constants here <<<<<
.align
