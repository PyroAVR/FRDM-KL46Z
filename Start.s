...
//  SIM_CLKDIV1: OUTDIV1=1,OUTDIV4=1
            LDR      R0,=SIM_CLKDIV1
            LDR      R1,=((1 << SIM_CLKDIV1_OUTDIV1_SHIFT) | (1 << SIM_CLKDIV1_OUTDIV4_SHIFT))
            STR      R1,[R0,#0]
//------------------------------------------
...
//  MCG_C2:  LOCRE0=0,RANGE0=2,HGO0=0,EREFS0=1,LP=0,IRCS=0
            LDR     R0,=MCG_BASE
            MOVS    R1,#((2 << MCG_C2_RANGE0_SHIFT) | MCG_C2_EREFS0_MASK)
...
//OSC0->CR:  ERCLKEN=1,EREFSTEN=0,SC2P=1,SC4P=0,SC8P=0,SC16P=0
            LDR     R2,=OSC0_CR
            MOVS    R1,#(OSC_CR_ERCLKEN_MASK | OSC_CR_SC2P_MASK)
            STRB    R1,[R2,#0]
...
//  MCG_C1:  CLKS=2,FRDIV=3,IREFS=0,IRCLKEN=1,IREFSTEN=0
            MOVS    R1,#((2 << MCG_C1_CLKS_SHIFT) | (3 << MCG_C1_FRDIV_SHIFT) | MCG_C1_IRCLKEN_MASK)
...
//MCG_C4:  DMX32=0,DRST_DRS=0
            ...
            MOVS    R1,#(MCG_C4_DMX32_MASK | MCG_C4_DRST_DRS_MASK)
            BICS    R2,R2,R1
...
//  MCG_C1:  CLKS=0,FRDIV=3,IREFS=0,IRCLKEN=1,IREFSTEN=0
            MOVS    R1,#((3 << MCG_C1_FRDIV_SHIFT) | MCG_C1_IRCLKEN_MASK)
            STRB    R1,[R0,#MCG_C1_OFFSET]
