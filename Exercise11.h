...
extern void putchar(char Character) asm("putchar");
extern void GetStringSB(char String[], int StringBufferCapacity) asm("GetStringSB");
extern void PutStringSB(char String[], int StringBufferCapacity) asm("PutStringSB");
extern void PutNumHex(UInt32) asm("PutNumHex");
extern void PutNumUB(UInt8) asm("PutNumUB");
extern uint8_t hex2nib(char n) asm("hex2nib");
...
#define ADC0_SC3_CAL (ADC_CAL_MASK | ADC_AVGE_MASK | \
                                           ADC_AVGS_MASK)
/*-------------------------------------------------------------*/
/* DAC */
